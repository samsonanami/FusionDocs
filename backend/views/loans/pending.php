        ...
        'columns' => [
            ...
            'buttons' => [
                'approve' => function($url, $model) {
                    return Html::a('<span class="btn btn-md btn-flat bg-olive"><b class="fa fa-check"></b> Approve</span>', ['approve', 'id' => $model['ln_id']], ['title' => 'Delete', 'class' => '', 'data' => ['confirm' => 'Are you absolutely sure ? You will change the status information about this loan with this action.', 'method' => 'post', 'data-pjax' => false],]);
                },
